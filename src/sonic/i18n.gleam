...
const zh = [
  ...
  #("Permissions", "权限"),
  #("Who can publish events", "谁可以发布活动"),
  #("Who can join events", "谁可以参加活动"),
  ...
  #("sent you a badge", "给你发了一枚徽章"),
  #("created a badge voucher", "创建了一个徽章凭证"),
  #("claimed a badge", "领取了一枚徽章"),
  #("transferred a badge", "转移了一枚徽章"),
  #("swapped a badge", "交换了一枚徽章"),
  #("burned a badge", "销毁了一枚徽章"),
  #("invited you to a group", "邀请你加入一个群组"),
  #("changed your role in a group", "修改了你在群组中的角色"),
  #("joined a shared badge", "加入了一个共享徽章"),
  #("minted a shared badge", "铸造了一个共享徽章"),
  #("updated an event", "更新了一个活动"),
  #("cancelled an event", "取消了一个活动"),
  #("Tracks", "分轨"),
  #("Holders", "持有者"),
  #("Search...", "搜索..."),
  #("No events yet.", "暂无活动"),
